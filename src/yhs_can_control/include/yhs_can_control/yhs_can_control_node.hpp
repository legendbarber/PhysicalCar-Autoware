...
private:
  ...
  rclcpp::Subscription<std_msgs::msg::Float64MultiArray>::SharedPtr ctrl_cmd_subscriber_;
  ...
  void ctrl_cmd_callback(const std_msgs::msg::Float64MultiArray::SharedPtr ctrl_cmd_msg);
